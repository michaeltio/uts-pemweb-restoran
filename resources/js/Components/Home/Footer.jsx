                        ...
                        <div className="lg:w-1/3 md:w-1/2 w-full px-4 mb-2">
                            ...
                            <nav className="list-none mb-2">
                                <p>
                                    ...
                                    <br/>全てのことの中で、私たちは皆様にご奉仕することに心血を注いでおります。皆様のご満足が、私たちの原動力です。ご選択いただき、誠にありがとうございます。そして、またご利用いただけることを心よりお待ちしております。
                                </p>
                            </nav>
                        </div>
                        <div className="lg:w-1/3 md:w-1/2 w-full px-4 mb-2">
                            ...
                            <nav className="list-none mb-2">
                                <li className="mb-2 hover:text-red-500">
                                    <p className='flex flex-row justify-center md:justify-start lg:justify-start xl:justify-start 2xl:justify-start'>
                                        <img className="w-6 h-6 mr-2" src={Telephone} alt='Icon' />
                                        +(021) 54220808
                                    </p>
                                </li>
                                <li className="mb-2 hover:text-red-500">
                                    <p className='flex flex-row justify-center md:justify-start lg:justify-start xl:justify-start 2xl:justify-start'>
                                        <img className="w-6 h-6 mr-2" src={Email} alt='Icon' />
                                        admisi@umn.ac.id
                                    </p>
                                </li>
                                <li className="mb-2 hover:text-red-500">
                                    <p className='flex flex-row justify-center md:justify-start lg:justify-start xl:justify-start 2xl:justify-start'>
                                        <img className="w-6 h-6 mr-2" src={Location} alt='Icon' />
