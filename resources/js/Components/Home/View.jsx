    ...
    return (
        <section className="text-black-900 body-font mx-16">
            <div className="container flex justify-center px-5 py-24 mx-auto">
                <div className="flex flex-wrap justify-center  -m-4">
                    ...
                    <div
                        ...
                        className="p-4 lg:w-1/4 md:w-1/2">
                        <div className="h-full flex flex-col items-center text-center">
                            <img alt="team" className="flex-shrink-0 rounded-lg w-full h-56 object-cover object-center mb-2" src="https://dummyimage.com/202x202" />
                            <div className="w-full">
                    ...
                    <div
                        ...
                        className="p-4 lg:w-1/4 md:w-1/2">
                        <div className="h-full flex flex-col items-center text-center">
                            <img alt="team" className="flex-shrink-0 rounded-lg w-full h-56 object-cover object-center mb-2" src="https://dummyimage.com/203x203" />
                            <div className="w-full">
            ...
            className='flex justify-center -mt-16 mb-5'>
                <button type="button" className="new-font text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center">
                    View All
