                        ...
                        <div className="bg-white rounded-lg shadow-xl">
                            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                ...
                                <form className='space-y-4 md:space-y-6' onSubmit={submit}>
                                    ...
                                    <PrimaryButton className="w-full justify-center bg-primary-600 hover:bg-primary-700 ring-1 focus:outline-none ring-slate-300 hover:bg-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center" disabled={processing}>
